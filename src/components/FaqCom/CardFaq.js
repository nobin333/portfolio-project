...
export default function CardFaq() {
  ...
  return (
    <section id="faq" className="relative h8-faq bg-white pb-20 pt-[130px]">
        ...
        <div className="mx-auto theme-container">
          <div className="relative flex items-center justify-center px-4 overflow-hidden md:px-0 rounded-3xl">
            <div className="max-w-[850px] w-full flex justify-center items-center flex-col relative z-10">
              <h1 className="py-0.5 px-5 bg-purple/10 border-purple/20 border rounded-[30px] font-medium text-purple">
                FAQs
              </h1>
              ...
              <div className="flex flex-col gap-2.5 w-full mt-5 md:mt-10 p-0 sm:p-5">
                ...
                {faqs.map((faq, index) => (
                  <div
                    key={index}
                    className={`py-5 px-2 md:px-9 w-full rounded-[10px] h9-faq-toggler overflow-hidden transition-all duration-300 max-h-fit h-fit border border-purple/10 ${
                      activeFAQ === index ? "bg-app-main" : ""
                    }`}
                  ...
                  >
                    ...
                    {activeFAQ === index && (
                      <p className="mt-3.5 text-main-black pointer-events-none h-fit">
                        {faq.answer}
                      </p>
                    )}
                  </div>
