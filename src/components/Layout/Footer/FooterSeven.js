    ...
    <footer className="pt-20 bg-it-black">
      <div className="flex flex-wrap justify-between gap-5 mx-auto mb-20 theme-container">
              ...
              <ul className="mt-3.5">
                <li className="">
                  <Link to="/project-details">
                    <div className="relative flex items-center gap-2 pr-5 overflow-hidden font-medium transition-all duration-300 group text-white/50 hover:text-white hover:underline">
                      <svg
        ...
        <div className="w-fit max-w-[300px]">
          ...
          />
          <Link to="/contact">
            <div className="home-two-btn-bg py-3.5 group bg-it-blue border-it-blue w-fit mt-2.5 before:bg-it-black after:bg-it-black">
              ...
              >
                <path
                  className="transition-all duration-300 group-hover:stroke-it-blue"
      ...
      <div className="w-full h-[80px] md:h-[65px] bg-it-black">
