...
export default function FooterSix() {
  return (
    <div className="bg-green-dark">
      ...
      <CtaSix />
      {/* <!-- cta end  --> */}
      <footer className="pt-20 bg-green-dark">
        <div className="flex flex-wrap justify-between gap-5 mx-auto mb-20 theme-container">
          <div className="w-fit max-w-[300px]">
            <img src="/assets/images/home-six/footer_logo.png" alt="logo" />
            <p className="max-w-[300px] text-white/55 my-6">
            ...
            <div className="flex gap-[15px]">
              <a
                ...
                aria-label="facebook"
                target="blank"
                className="w-[46px] h-[46px] rounded-full flex justify-center items-center border border-white/10 overflow-hidden relative before:inline-block before:absolute before:z-0 before:w-full before:h-full before:bg-orange before:scale-x-0 group hover:before:scale-x-100 before:origin-right hover:before:origin-left before:transition-transform before:ease-out before:duration-300"
              >
          ...
          <div className="w-fit max-w-[300px]">
            ...
            <input
              ...
              id="eFive"
              className="bg-transparent border border-white/10 py-2.5 px-6 rounded-[28px] focus:outline-none w-full mt-5 text-white"
            />
            <Link to="/contact">
              <div className="home-two-btn-bg py-3.5 group bg-orange border-orange w-fit mt-2.5 before:bg-green-dark after:bg-green-dark">
                ...
                >
                  <path
                    className="transition-all duration-300 group-hover:stroke-orange"
        ...
        <div className="w-full h-[80px] md:h-[65px] bg-[#122E25]">
