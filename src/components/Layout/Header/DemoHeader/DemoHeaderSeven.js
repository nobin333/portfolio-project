...
export default function DemoHeaderSeven() {
  return (
      ...
      <div className="px-[70px] w-full">
        <header className="relative flex items-center justify-between w-full h-full py-6 mx-auto">
          ...
          <ul className="flex items-center gap-10 text-base font-medium leading-5 text-main-black font-inter h-fit">
            <li className="group">
              <a
                className="home-two-nav-item leading-5 relative before:content-['Home'] before:text-it-blue hover:text-it-blue delay-200 before:border-it-blue w-fit flex items-center gap-2"
                href="#"
              >
                Home
                <svg
            ...
            <li>
              <Link
                to="/about"
                className="home-two-nav-item relative before:content-['Company'] before:text-it-blue before:border-it-blue hover:text-it-blue delay-200"
              >
                Company
              </Link>
            </li>
            ...
            <li>
              <Link
                className="home-two-nav-item relative before:content-['Blogs'] before:text-it-blue before:border-it-blue hover:text-it-blue delay-200"
                to="/blogs"
              >
                Blogs
              </Link>
            ...
            <li className="relative group">
              <a
                href="#"
                className="home-two-nav-item relative before:content-['Pages'] before:text-it-blue before:border-it-blue flex items-center gap-2 hover:text-it-blue delay-200"
              >
                Pages
                <svg
                  className="transition-all duration-300 group-hover:rotate-180"
                ...
                <ul className="max-h-fit min-w-[200px] bg-white mt-8 shadow-card-sm transition-all duration-300 overflow-hidden px-5 top-20 pb-4 rounded-b-md">
                  {pagesLinkData.map((item, index) => (
                    <li key={index} className="relative py-1">
                      <Link
                        className="relative leading-5 home-two-nav-item hover:text-it-blue w-fit before:border-it-blue"
                        to={item.pageLink}
                      >
                        {item.linkLabel}
                      </Link>
            ...
            <li>
              <Link
                className="home-two-nav-item relative before:content-['Contact'] before:text-it-blue before:border-it-blue hover:text-it-blue delay-200"
                to="/contact"
              >
                Contact
              </Link>
