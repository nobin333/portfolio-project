...
export default function DemoHeaderSix() {
  return (
    <div className="fixed top-0 z-20 justify-center hidden w-full h-24 xl:flex bg-green-dark">
        ...
        <header className="relative flex items-center justify-between w-full h-full py-6 mx-auto border-b border-white/10">
          <div className="flex items-center gap-24">
            ...
            <ul className="flex items-center gap-10 text-base font-medium leading-5 text-white font-inter h-fit">
              <li className="group">
                <a
                  className="home-two-nav-item leading-5 relative before:content-['Home'] before:text-white before:border-white w-fit flex items-center gap-2"
                  href="#"
                >
                  Home
                  <svg
              ...
              <li>
                <Link
                  to="/about"
                  className="home-two-nav-item relative before:content-['Company'] before:text-white before:border-white"
                >
                  Company
                </Link>
              </li>
              ...
              <li>
                <Link
                  className="home-two-nav-item relative before:content-['Blogs'] before:text-white before:border-white"
                  to="/blogs"
                >
                  Blogs
                </Link>
              ...
              <li className="relative group">
                <a
                  href="#"
                  className="home-two-nav-item relative before:content-['Pages'] before:text-white before:border-white flex items-center gap-2"
                >
                  Pages
                  <svg
                    className="transition-all duration-300 group-hover:rotate-180"
                ...
                <div className="absolute px-2 -left-7 h-0 group-hover:h-[340px] overflow-hidden top-5 transition-all duration-700">
                  <ul className="max-h-fit min-w-[200px] bg-green-dark mt-8 shadow-card-sm transition-all duration-300 overflow-hidden px-5 top-20 pb-4 rounded-b-md flex flex-col items-start">
              ...
              <li>
                <Link
                  className="home-two-nav-item relative before:content-['Contact'] before:text-white before:border-white"
                  to="/contact"
                >
                  Contact
                </Link>
