...
export default function LandingHeaderEight() {
  return (
      ...
      <div className="px-[70px] w-full">
        <header className="relative flex items-center justify-between w-full h-full py-6 mx-auto">
          ...
          <ul className="flex items-center gap-10 text-base font-medium leading-5 text-main-black font-inter h-fit">
            <li className="group">
              <a
                className="home-two-nav-item leading-5 relative before:content-['Banner'] before:text-blue-sass before:border-blue-sass w-fit before:h-[20px] flex items-center gap-2 hover:text-blue-sass delay-150"
                href="#banner"
              >
                Banner
                <svg
            ...
            <li>
              <a
                href="#about"
                className="home-two-nav-item relative before:content-['About'] before:text-blue-sass before:border-blue-sass before:h-[20px]"
              >
                About
              </a>
            </li>
            <li>
              <a
                href="#features"
                className="home-two-nav-item relative before:content-['Features'] before:text-blue-sass before:border-blue-sass before:h-[20px]"
              >
                Features
              </a>
            </li>
            <li>
              <a
                className="home-two-nav-item relative before:content-['Testimonials'] before:text-blue-sass before:border-blue-sass before:h-[20px]"
                href="#testimonials"
              >
                Testimonials
              </a>
            ...
            <li>
              <a
                className="home-two-nav-item relative before:content-['Faq'] before:text-blue-sass before:border-blue-sass before:h-[20px]"
                href="#faq"
              >
                Faq
              </a>
            ...
            <li>
              <a
                className="home-two-nav-item relative before:content-['Cta'] before:text-blue-sass before:border-blue-sass before:h-[20px]"
                href="#cta"
              >
                Cta
              </a>
