...
export default function LandingHeaderNine() {
  return (
      ...
      <div className="px-[70px] w-full">
        <header className="relative flex items-center justify-between w-full h-full py-6 mx-auto">
          ...
          <ul className="flex items-center gap-10 text-base font-medium leading-5 text-main-black font-inter h-fit">
            <li className="group">
              <a
                className="home-two-nav-item leading-5 relative before:content-['Banner'] before:text-main-black before:border-main-black w-fit before:h-[20px] flex items-center gap-2"
                href="#banner"
              >
                Banner
                <svg
            ...
            <li>
              <a
                href="#features"
                className="home-two-nav-item relative before:content-['Features'] before:text-main-black before:border-main-black before:h-[20px]"
              >
                Features
              </a>
            </li>
            <li>
              <a
                className="home-two-nav-item relative before:content-['Solutions'] before:text-main-black before:border-main-black before:h-[20px]"
                href="#solutions"
              >
                Solutions
              </a>
            ...
            <li>
              <a
                className="home-two-nav-item relative before:content-['Process'] before:text-main-black before:border-main-black before:h-[20px]"
                href="#process"
              >
                Process
              </a>
            ...
            <li>
              <a
                className="home-two-nav-item relative before:content-['Testimonials'] before:text-main-black before:border-main-black before:h-[20px]"
                href="#testimonials"
              >
                Testimonials
              </a>
            ...
            <li>
              <a
                className="home-two-nav-item relative before:content-['Faq'] before:text-main-black before:border-main-black before:h-[20px]"
                href="#faq"
              >
                Faq
              </a>
            ...
            <li>
              <a
                before="Our&nbsp;App"
                className="home-two-nav-item relative before:content-[attr(before)] before:text-main-black before:border-main-black before:h-[20px]"
                href="#ourApp"
              >
                Our App
              </a>
