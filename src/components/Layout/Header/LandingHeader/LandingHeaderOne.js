...
export default function LandingHeaderOne() {
  return (
    <header className="relative z-50">
      <div className="fixed top-0 left-0 z-50 hidden w-full header-wrapper xl:block">
        <div className="2xl:px-[110px] px-5 mx-auto relative">
          <div className="w-full h-[45px] justify-between items-center pl-[50px] bg-white border border-[#e7e8e9] hidden h1-top-bar">
            <span className="hidden 2xl:block">
              Welcome to
              <span className="font-semibold text-purple">Quland</span> a modern
              ...
              <div>
                <ul className="flex items-center space-x-10">
                  <li className="z-50 group">
                    ...
                    <div className="absolute px-[18px] left-0 h-0 group-hover:h-[660px] overflow-hidden top-[92px] transition-all duration-700 z-50 bg-white group-hover:border-b group-hover:border-r group-hover:border-l border-[#e7e8e9]">
                  ...
                  <li className="flex items-center">
                    <input
                      id="hh-search"
                      type="text"
                      className="w-0 px-0 transition-all duration-300 border-0 rounded-md border-purple/10 focus:outline-none focus:border focus:w-48 focus:mr-2 focus:px-2"
                      placeholder="Search..."
                    />
                    <label
