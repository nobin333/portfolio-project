...
export default function LandingHeaderTwo() {
  return (
      ...
      <header className="flex justify-between max-w-[1619px] relative py-6 mx-auto items-center h-full w-full px-5">
        <div className="flex items-center gap-28">
          ...
          <ul className="flex gap-10 text-base font-medium leading-5 text-paragraph font-inter">
            <li className="group">
              <a
                className="home-two-nav-item leading-5 relative before:content-['Banner'] w-fit flex gap-2 items-center hover:text-purple"
                href="#banner-two"
              >
                Banner
                <svg
            ...
            <li>
              <a
                href="#features"
                className="home-two-nav-item relative before:content-['features']"
              >
                Home
              </a>
            </li>
            <li>
              <a
                className="home-two-nav-item relative before:content-['About']"
                href="#about"
              >
                About
              </a>
            ...
            <li>
              <a
                before="Case&nbsp;Studies"
                className="home-two-nav-item relative before:content-[attr(before)]"
                href="#caseStudies"
              >
                Case Studies
              </a>
            ...
            <li>
              <a
                className="home-two-nav-item relative before:content-['Testimonials']"
                href="#testimonials"
              >
                Testimonials
              </a>
            ...
            <li>
              <a
                className="home-two-nav-item relative before:content-['Faq']"
                href="#faq"
              >
                Faq
              </a>
