...
export default function TeamOne() {
  return (
    <section
      id="teamMembers"
      className="bg-main-black py-16 md:py-[130px] relative"
    >
      <img
        src="/assets/images/home-three/teams/bg.svg"
        alt=""
        className="absolute top-0 left-0 top-bottom-moving"
      />
        ...
        <div className="grid gap-[30px] grid-cols-3 md:grid-cols-6 lg:grid-cols-12 mt-10 md:mt-[70px]">
          ...
          <div className="col-span-3">
            ...
            <h1 className="mt-6 font-semibold text-white text-22 white_card_title">
              <Link to="/teams"> Steven N. Manning</Link>
            </h1>
          ...
          <div className="col-span-3">
            ...
            <h1 className="mt-6 font-semibold text-white text-22 white_card_title">
              <Link to="/teams"> Lawrence P. Harrison</Link>
            </h1>
          ...
          <div className="col-span-3">
            ...
            <h1 className="mt-6 font-semibold text-white text-22 white_card_title">
              <Link to="/teams">Matthew D. Banks</Link>
            </h1>
          ...
          <div className="col-span-3">
            ...
            <h1 className="mt-6 font-semibold text-white text-22 white_card_title">
              <Link to="/teams">Richard S. Sanders</Link>
            </h1>
