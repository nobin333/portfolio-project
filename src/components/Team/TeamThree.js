      ...
      <div className="w-full mx-auto theme-container">
        ...
        <div className="grid gap-[30px] grid-cols-3 md:grid-cols-6 lg:grid-cols-12 mt-10 md:mt-[70px]">
          ...
          >
            ...
            <p className="mt-1 text-paragraph">Product Designer</p>
          </div>
          {/* <!-- single card start  --> */}
          {/* <!-- single card start  --> */}
          <div
          ...
          >
            ...
            <h1 className="mt-6 font-semibold text-22 text-main-black white_card_title">
              <a href="#"> Lawrence P. Harrison</a>
            </h1>

            <p className="mt-1 text-paragraph">Web Developer</p>
          </div>
          {/* <!-- single card start  --> */}
          {/* <!-- single card start  --> */}
          <div
          ...
          >
            ...
            <h1 className="mt-6 font-semibold text-22 text-main-black white_card_title">
              <a href="#">Matthew D. Banks</a>
            </h1>

            <p className="mt-1 text-paragraph">Graphics Designer</p>
          </div>
          {/* <!-- single card start  --> */}
          {/* <!-- single card start  --> */}
          <div
          ...
          >
            <div className="relative flex items-center justify-center overflow-hidden group/main">
              <img
                src="/assets/images/home-three/teams/5.webp"
                alt=""
                className="object-cover w-full overflow-hidden rounded-lg"
              />
              {/* <!-- social links  --> */}
          ...
          >
            <div className="relative flex items-center justify-center overflow-hidden group/main">
              <img
                src="/assets/images/home-three/teams/6.webp"
                alt=""
                className="object-cover w-full overflow-hidden rounded-lg"
              />
              {/* <!-- social links  --> */}
          ...
          >
            <div className="relative flex items-center justify-center overflow-hidden group/main">
              <img
                src="/assets/images/home-three/teams/7.webp"
                alt=""
                className="object-cover w-full overflow-hidden rounded-lg"
              />
              {/* <!-- social links  --> */}
          ...
          >
            <div className="relative flex items-center justify-center overflow-hidden group/main">
              <img
                src="/assets/images/home-three/teams/8.webp"
                className="object-cover w-full overflow-hidden rounded-lg"
                alt=""
              />
              {/* <!-- social links  --> */}
