...
export default function TestimonialSeven() {
  ...
  return (
    <section id="testimonial" className="py-[70px] sm:py-[130px] bg-it-gray">
      <div className="w-full mx-auto theme-container">
        ...
        <div className="w-full">
          <div className="h5-story-slider h7-testimonial-slider pt-14 pb-[50px]">
              ...
              <SwiperSlide>
                <div className="flex flex-col items-center relative pt-[52px] pb-10 px-11 bg-white rounded-2xl">
                  ...
                  <h1 className="mt-5 mb-8 font-medium text-center text-18 text-main-black">
                    ...
                    staying ahea Through blog invite explore the dynamic world
                    with us decoding algorithms
                  </h1>
                  <img
        ...
        <div className="relative flex items-center mx-auto w-fit">
          <div className="absolute flex justify-between w-full">
            <button className="group h5-story-prev w-[30px] h-[30px] rounded-full flex items-center justify-center bg-it-blue/10 border-it-blue/20 overflow-hidden before:inline-block before:w-11 before:h-11 before:border-[1.5px] before:border-it-blue before:bg-it-blue relative before:absolute before:z-0 before:-right-12 hover:before:right-0 before:transition-all before:duration-300">
              <svg
              ...
              >
                <path
                  className="stroke-it-blue group-hover:stroke-white"
            ...
            <button className="group rotate-180 h5-story-next w-[30px] h-[30px] rounded-full flex items-center justify-center bg-it-blue/10 border-it-blue/20 overflow-hidden before:inline-block before:w-11 before:h-11 before:border-[1.5px] before:border-it-blue before:bg-it-blue relative before:absolute before:z-0 before:-right-12 hover:before:right-0 before:transition-all before:duration-300">
              <svg
                className="relative z-10 pointer-events-none"
                width="12"
                height="10"
          ...
          <div className="px-10 h5-story-pagination h7-pagination"></div>
        </div>
      </div>
    </section>
  );
